...
Оказываю [консультационные услуги по веб-разработке](https://career.habr.com/efiand#expert-profile):

- 7 лет был наставником в HTML Academy по вёрстке и javascript. Провожу индивидуальное обучение фронтенд-разработке по полной программе и дополнительные занятия для учеников и выпускников онлайн-школ.
- Техлид в крупной продуктовой компании. Помогаю с решением продуктовой задачи или выполнением тестового задания.
...
2. Наставник по фронтенд-разработке в [HTML Academy](https://htmlacademy.ru)

   _Сентябрь 2018 — май 2025_
